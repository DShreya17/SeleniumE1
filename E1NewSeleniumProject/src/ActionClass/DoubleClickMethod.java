...
public class DoubleClickMethod {
	...
	public static void main(String[] args) {
		...
		Actions act = new Actions(driver);//To create objects of action class
		...
		act.doubleClick(ratingButton3).perform();//To perform double click operation on rating 'button'
