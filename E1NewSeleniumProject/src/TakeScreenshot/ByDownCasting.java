...
public class ByDownCasting {
	...
	public static void main(String[] args) throws IOException {
		...
		File src = rwd.getScreenshotAs(OutputType.FILE);//To take the screenshot
		
		File dest = new File("./screenshots/Flipkart.jpg");//To specify the location, name and extensions
